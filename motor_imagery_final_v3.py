#!/usr/bin/env python3
"""
EEG Motor Imagery Classification - Final Version v3
- CSP features (single-band mu + beta)
...
print("="*60)
print("EEG MOTOR IMAGERY - FINAL V3 (Balanced)")
print("="*60)
...
for trial in range(n_trials):
    ...
    for ch in range(n_channels):
        ...
        # BALANCED motor imagery effect: 65% show effect, 15% change
...
csp_features = compute_csp_features(X, y, fs, n_components=3)
print(f"    CSP features: {csp_features.shape}")

beta_csp = compute_beta_csp(X, y, fs, n_components=2)
print(f"    Beta CSP: {beta_csp.shape}")
